/* Generated By:JJTree: Do not edit this line. ASTProgramma.java */
...
public class ASTProgramma extends SimpleNode {
  public ASTProgramma(int id) {
    super(id);
  }

  public ASTProgramma(Parser p, int id) {
    super(p, id);
  }
